namespace WallstopStudios.DxCommandTerminal.Tests.Runtime
{
    ...
    public sealed class TryEatArgumentTests
    {
        ...
        [TestCase(
            ...
            null,
            null,
            Description = "First word of multi-word input"
        )]
        ...
        [TestCase(
            ...
            '"',
            null,
            Description = "Unclosed double quote consumes rest"
        )]
        [TestCase(
            "'unclosed",
            true,
            ...
            '\'',
            null,
            Description = "Unclosed single quote consumes rest"
        )]
        ...
        [TestCase(
            ...
            '\'',
            '\'',
            Description = "Single-quoted string with space"
        )]
        [TestCase(
            "\"hello world\" rest",
            true,
            ...
            '"',
            '"',
            Description = "Quoted with remainder"
        )]
        [TestCase(
            "'hello' rest",
            true,
            ...
            '\'',
            '\'',
            Description = "Single-quoted with remainder"
        )]
        ...
        [TestCase(
            ...
            '"',
            '"',
            Description = "Leading whitespace before quote"
        )]
        [TestCase(
            "'hello \"world\"'",
            true,
        ...
        [TestCase(
            ...
            null,
            null,
            Description = "Multiple consecutive spaces returns first word"
        )]
        [TestCase(
            "hello\tworld",
            true,
        ...
        [TestCase(
            ...
            '"',
            '"',
            Description = "Text after closing quote stops at quote"
        )]
        ...
        )
        {
            ...
            Assert.AreEqual(
                expectedResult,
                result,
                $"TryEatArgument return value mismatch for input: \"{input}\""
            );
        ...
        [TestCase(
            ...
            "hello",
            "world",
            Description = "Remainder after unquoted word has space consumed"
        )]
        [TestCase(
            "\"quoted\" rest",
            "quoted",
            " rest",
            Description = "Remainder after quoted arg preserves leading space"
        )]
        ...
        [TestCase(
            ...
            "quoted",
            "extra",
            Description = "Text after closing quote is remainder"
        )]
        [TestCase(
            "\"unclosed with spaces",
            "unclosed with spaces",
            "",
            Description = "Unclosed quote with spaces consumes all"
        )]
