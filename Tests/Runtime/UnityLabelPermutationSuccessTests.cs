namespace WallstopStudios.DxCommandTerminal.Tests.Runtime
{
    ...
    public sealed class UnityLabelPermutationSuccessTests
    {
        ...
        {
            CommandArg arg = new CommandArg("y:2 x:1");
        ...
        {
            CommandArg arg = new CommandArg("w:4 z:3 y:2 x:1");
        ...
        {
            CommandArg arg = new CommandArg("{r:0.1 g:0.2 b:0.3 a:0.4}");
        ...
        {
            CommandArg arg = new CommandArg("y:5 x:-3");
        ...
        {
            CommandArg arg = new CommandArg("z:9 y:8 x:7");
