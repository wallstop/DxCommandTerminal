namespace WallstopStudios.DxCommandTerminal.Tests.Runtime
{
    ...
    public sealed class UnityExtremeParsingTests
    {
        ...
        {
            CommandArg arg = new("1e20,-2e20,3.4e10");
        ...
        {
            CommandArg arg = new("-5e15,6e15,-7e15,8e15");
        ...
        {
            CommandArg arg = new("1e10,-1e10,2e10,3e10");
        ...
        {
            CommandArg arg = new("1e10,2e10,3e10,4e10");
        ...
        {
            CommandArg arg = new("z:3 y:2 x:1");
            Assert.IsTrue(arg.TryGet(out Vector3 v));
        ...
        {
            CommandArg arg = new("width:100 height:50 y:20 x:10");
            Assert.IsTrue(arg.TryGet(out Rect r));
            Assert.AreEqual(10f, r.x, 1e-4f);
            Assert.AreEqual(20f, r.y, 1e-4f);
        ...
        {
            CommandArg arg = new("w:0.4 z:0.3 y:0.2 x:0.1");
            Assert.IsTrue(arg.TryGet(out Quaternion q));
