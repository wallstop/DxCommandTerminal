namespace WallstopStudios.DxCommandTerminal.Tests.Runtime
{
    ...
    public sealed class UnityMalformedParsingTests
    {
        ...
        {
            CommandArg arg = new CommandArg("x: y:2 z:");
        ...
        {
            CommandArg arg = new CommandArg("x: y:5");
        ...
        {
            CommandArg arg = new CommandArg("x:0.1 y:0.2 z:0.3");
        ...
        {
            CommandArg arg = new CommandArg("x:10 y:20 width: height:50");
        ...
        {
            CommandArg arg = new CommandArg("x:10 y:20");
        ...
        {
            CommandArg arg = new CommandArg("1,foo");
        ...
        {
            CommandArg arg = new CommandArg("1,2,3.5,4");
            Assert.IsFalse(arg.TryGet(out RectInt _));
        }
        ...
        {
            CommandArg arg = new CommandArg("0.1, nope, 0.3, 0.4");
            Assert.IsFalse(arg.TryGet(out Quaternion _));
        }
        ...
        {
            CommandArg arg = new CommandArg("red, green, blue");
            Assert.IsFalse(arg.TryGet(out Color _));
        }
        ...
        {
            CommandArg arg = new CommandArg("x:1 x: y:3");
            Assert.IsFalse(arg.TryGet(out Vector3 _));
        }
        ...
        {
            CommandArg arg = new CommandArg("x:10 y:20 width:100 width: height:50");
            Assert.IsFalse(arg.TryGet(out Rect _));
        }
        ...
        {
            CommandArg arg = new CommandArg("x:0.1 y:0.2 z:0.3 w:");
            Assert.IsFalse(arg.TryGet(out Quaternion _));
        }
        ...
        {
            CommandArg arg = new CommandArg("x:1 x: y:2");
            Assert.IsFalse(arg.TryGet(out Vector2Int _));
        }
    }
}
