namespace WallstopStudios.DxCommandTerminal.Tests.Runtime
{
    ...
    public sealed class UnityBoundaryMalformedTests
    {
        ...
        {
            CommandArg arg = new CommandArg("2147483648,0"); // int.MaxValue + 1
        ...
        {
            CommandArg arg = new CommandArg("-2147483649,0"); // int.MinValue - 1
            Assert.IsFalse(arg.TryGet(out Vector2Int _));
        }
        ...
        {
            CommandArg arg = new CommandArg("0,999999999999999999999,0");
        ...
        {
            CommandArg arg = new CommandArg("0,0,2147483648,10");
        ...
        {
            CommandArg arg = new CommandArg("0,0,10,2147483648");
            Assert.IsFalse(arg.TryGet(out RectInt _));
        }
        ...
        {
            CommandArg arg = new CommandArg("RGBA(0.1,0.2,0.3,)");
